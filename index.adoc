...
* Transformers allow selection of a different functor
* Transformers are often considered difficult to use
* Transformers introduce additional wrapping, which leads to concerns over performance
